...
bedtools nuc -fi $GENOMEFA -bed $TEDISJOINED -pattern 'TG' > ${GENOME}.filtered_disjoined_TEs.ecology.tg.out
bedtools nuc -fi $GENOMEFA -bed $TEDISJOINED -pattern 'CA' > ${GENOME}.filtered_disjoined_TEs.ecology.ca.out

paste <(cat ${GENOME}.filtered_disjoined_TEs.ecology.cg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.cag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ctg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ccg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.caa.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.cat.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.cac.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.cta.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ctt.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ctc.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ccc.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.cca.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.cct.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ttg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.atg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.gtg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.tag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.aag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.gag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ggg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.tgg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.agg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.tg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.ecology.ca.out ) > ${GENOME}.filtered_disjoined_TEs.ecology.cytpatterns.out
...
bedtools nuc -fi $GENOMEFA -bed $FLANKGFF -pattern 'TG' > ${GENOME}.filtered_disjoined_TEs.flank.tg.out
bedtools nuc -fi $GENOMEFA -bed $FLANKGFF -pattern 'CA' > ${GENOME}.filtered_disjoined_TEs.flank.ca.out

paste <(cat ${GENOME}.filtered_disjoined_TEs.flank.cg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.cag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ctg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ccg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.caa.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.cat.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.cac.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.cta.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ctt.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ctc.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ccc.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.cca.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.cct.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ttg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.atg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.gtg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.tag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.aag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.gag.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ggg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.tgg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.agg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.tg.out ) <(cut -f19 ${GENOME}.filtered_disjoined_TEs.flank.ca.out ) > ${GENOME}.filtered_disjoined_TEs.flank.cytpatterns.out
